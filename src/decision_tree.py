...
joblib.dump(salary_to_numeric, '../encoders/salary_to_numeric_decision_tree.pkl')
...
joblib.dump(label_encoders, '../encoders/label_encoders_decision_tree.pkl')
...
# 7. DecisionTreeRegressor Modelinin Eğitilmesi
model = DecisionTreeRegressor(random_state=42)
model.fit(X_train, y_train)

# Modeli kaydetme
joblib.dump(model, '../models/decision_tree_model.pkl')
print("DecisionTreeRegressor modeli başarıyla kaydedildi.")
...
with open("../results/decision_tree_results.txt", "w", encoding="utf-8") as f:
    f.write("\nModel Performansı:")
