...
joblib.dump(salary_to_numeric, '../encoders/salary_to_numeric_lr.pkl')
...
joblib.dump(label_encoders, '../encoders/label_encoders_lr.pkl')
...
# Scaler'ı kaydetme
joblib.dump(scaler, '../scalers/scaler_lr.pkl')
print("Scaler başarıyla kaydedildi.")

# 7. Linear Regression Modelinin Eğitilmesi
model = LinearRegression()
model.fit(X_train, y_train)

# Modeli kaydetme
joblib.dump(model, '../models/linear_regression_model.pkl')
print("Linear Regression modeli başarıyla kaydedildi.")
...
with open("../results/linear_regression_results.txt", "w", encoding="utf-8") as f:
    f.write("\nModel Performansı:")
