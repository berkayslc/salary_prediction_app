...
joblib.dump(salary_to_numeric, '../encoders/salary_to_numeric_xgb.pkl')
...
joblib.dump(label_encoders, '../encoders/label_encoders_xgb.pkl')
...
# Scaler'ı kaydetme
joblib.dump(scaler, '../scalers/scaler_xgb.pkl')
print("Scaler başarıyla kaydedildi.")

# 7. XGBRegressor Modelinin Eğitilmesi
model = XGBRegressor(n_estimators=100, learning_rate=0.1, random_state=42)
model.fit(X_train, y_train)

# Modeli kaydetme
joblib.dump(model, '../models/xgboost_model.pkl')
print("XGBRegressor modeli başarıyla kaydedildi.")
