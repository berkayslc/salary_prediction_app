...
joblib.dump(salary_to_numeric, '../encoders/salary_to_numeric_rf.pkl')
...
joblib.dump(label_encoders, '../encoders/label_encoders_rf.pkl')
...
# Scaler'ı kaydetme
joblib.dump(scaler, '../scalers/scaler_rf.pkl')
print("Scaler başarıyla kaydedildi.")

# 7. RandomForestRegressor Modelinin Eğitilmesi
model = RandomForestRegressor(n_estimators=100, random_state=42)
model.fit(X_train, y_train)

# Modeli kaydetme
joblib.dump(model, '../models/random_forest_model.pkl')
print("RandomForestRegressor modeli başarıyla kaydedildi.")
